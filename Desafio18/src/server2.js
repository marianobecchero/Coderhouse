...
const { ProductGraphQLRouter } = require('./router/ProductGraphQLRouter.js')
...
const productGraphQLRouter = new ProductGraphQLRouter(graphqlHTTP)
...
app.use('/api/graphql', productGraphQLRouter)
