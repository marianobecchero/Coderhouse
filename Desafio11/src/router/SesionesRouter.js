...
const { runInNewContext } = require('vm')
  ...
  SesionesRouter.get('/failregister', (req, res) => {
    ...
    //res.sendFile(process.cwd() + '/src/views/register-error.html')
    res.sendFile(path.resolve(__dirname, '../views/register-error.html'))
  })
...
SesionesRouter.get('/faillogin', (req, res) => {
    ...
    //res.sendFile(process.cwd() + '/src/views/login-error.html')
    res.sendFile(path.resolve(__dirname, '../views/login-error.html'))
})
